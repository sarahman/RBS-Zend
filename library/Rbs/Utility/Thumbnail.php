 ...
 * @version			1.1 (PHP5)
 * @see				http://www.gen-x-design.com/projects/php-thumbnailer-class/
 */

/**
 * PHP class for dynamically resizing, cropping, and rotating images
 * for thumbnail purposes and either displaying them on-the-fly or
 * saving them.
 */
class Rbs_Utility_Thumbnail
{
    /**
    ...
    public function __construct($fileName)
    {
        ...
        if (!file_exists($this->fileName)) {
            $this->errmsg = 'File not found at ' . $fileName;
            $this->error = true;
        }
